			...
			<div class="row">
	    		...
	    		<div class="col-sm-12">
	    			...
	    			<div class="contact-form">
						...
						?>
						<div class="status alert alert-success">Successfully Updated</div>
						<input type="hidden" name="id" value="<?php echo $id; ?>" >
				            <div class="form-group col-md-12">
							
				                <textarea name="message" id="message" class="form-control" rows="8" placeholder=""><?php echo $message; ?></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
