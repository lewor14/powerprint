	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
							...
							<p>Manila City</p>
							<p>Philippines</p>
							<p>Mobile: +639175160123</p>
							<p>Email: printit@gmail.com</p>
	    				</address>						
	    				...
	    				<div class="social-networks">
							...
							<ul>
								<li>
									<a href="https://facebook.com/mary.elaine.22"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://instagram.com/maryelaineyy"><i class="fa fa-instagram"></i></a>
								</li>
								<!--<li>
